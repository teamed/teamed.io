...
(four pending patents about this mechanism).
...
for UI web apps and RESTful APIs, an OOP alternative
...
in on-demand Docker containers, communicating with over 100 open source
...
There is no waste of money here, because we don't pay <strong>salaries</strong>.
...
You get an access to an unlimited talent pool
...
skills experience. We even [encourage](http://www.yegor256.com/2014/04/13/no-obligations-principle.html)
